...
export function ProductCard({
	...
	return (
		<div
			dir="ltr"
			className={`group relative inline-block h-[380px] overflow-hidden rounded-[14px] ${navigateUrl ? "cursor-pointer" : "cursor-default"}`}
		...
		>
			...
			>
				...
				<div className="absolute bottom-0 left-0 w-full bg-linear-to-t from-black/35 via-black/10 to-transparent [mask-image:linear-gradient(to_top,black_70%,transparent_100%)]">
